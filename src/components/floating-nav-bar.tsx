...
export function FloatingNavBar({
  ...
  return (
    <div className={cn('fixed bottom-10 left-1/2 z-40 -translate-x-1/2', className)}>
      <div
        ref={containerRef}
        className="relative flex max-w-100 items-center gap-1 rounded-xl border border-border bg-bg-overlay p-1 shadow-lg backdrop-blur-md"
      >
        {items.map((item, index) => {
          ...
          return (
            <button
              ...
              className="relative flex min-w-0 flex-1 flex-col items-center gap-0.5 rounded-xl px-2 py-1.5"
            >
